...
- (void) myButtonLongPressed:(UILongPressGestureRecognizer *)gesture
{
    ...
    if (gesture.state == UIGestureRecognizerStateEnded) {
        ...
        //// begin iphono specific ////
        //// hold button to record, instantly playback your recording when record button is released ////
        [self playRecording];
        //// end iphono specific ////
    }
...
-(IBAction) startRecording
{
    ...
    //// begin iphono specific ////
    //// start the audiosession with default routes (e.g. record through headset mic when plugged in) ////
    
    [audioSession overrideOutputAudioPort:AVAudioSessionPortOverrideNone error:nil]; //set default route for recording
...
-(IBAction) stopRecording
{
    ...
    //// iphono specific ////
    //// stop the audiosession to clear the routes ////
    
    AVAudioSession *audioSession = [AVAudioSession sharedInstance];
    [audioSession setActive:NO error:nil]; //stop session
...
-(IBAction) playRecording
{
    ...
    //// begin iphono specific ////
    //// start a new audio session on playback. ////
    //// important:  PlayAndRecord as category, OverrideSpeaker to change from default headset output route to speaker (only PlayAndRecord scat supports this...) ////
    
    
    AVAudioSession *audioSession = [AVAudioSession sharedInstance];
    [audioSession setActive:YES error:nil]; //start session (the start and stop could possible go..)
    
    [audioSession setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:(AVAudioSessionCategoryOptionDefaultToSpeaker && AVAudioSessionCategoryOptionMixWithOthers) error:nil]; //changed Cat to Playandrec. instead of playback
    [audioSession overrideOutputAudioPort:AVAudioSessionPortOverrideSpeaker error:nil];
    
    //// end of iphono specific ////
